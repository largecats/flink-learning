...
//                )
                ...
                .window(TumblingEventTimeWindows.of(Time.seconds(10))) // number of events per id per window
//                .windowAll(TumblingEventTimeWindows.of(Time.seconds(10))) // total number of events per window
                .sum("count");
