...
public class BroadcastState {
    ...
    */
    public static void main(String[] args) throws Exception {
        ...
        KeyedStream<Item, Color> colorPartitionedStream = itemStream.keyBy(x -> x.color); // If Color class overrides hashCode() and equals(), can key by color
//        KeyedStream<Item, String> colorPartitionedStream = itemStream.keyBy(x -> x.color.value); // If not, can key by color.value
...
This issue disappeared after changing to keyBy(x -> x.color.value), where x.color.value is String.
...
To key by POJO (https://ci.apache.org/projects/flink/flink-docs-release-1.12/dev/types_serialization.html#pojos), need to override
1) hashCode() (See keyBy documentation in https://ci.apache.org/projects/flink/flink-docs-release-1.12/dev/stream/operators/.), and
2) equals() (for key comparison)
