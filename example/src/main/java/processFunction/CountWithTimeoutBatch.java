...
//        System.out.println(env.getExecutionPlan()); // Print execution plan
...
source shut down (cancelled)
[key a, 8500L] timer fires => this is the latest timer for key a => output (a, 4)
[key b, 9000L] timer fires => this is the latest timer for key b => output (b, 4)
...
source shut down (cancelled)
timer [key b, 9000L] fires => this is the latest timer for key b => output (b, 4)
