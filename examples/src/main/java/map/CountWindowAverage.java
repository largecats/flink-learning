...
public class CountWindowAverage {
    ...
    public static void main(String[] args) throws Exception {
        ...
        .flatMap(new CountWindowAverageFlatMapFunction())
        .print();

        env.execute();
    }

    public static class CountWindowAverageFlatMapFunction extends RichFlatMapFunction<Tuple2<Long, Long>, Tuple2<Long, Double>> {
        ...
        public void open(Configuration config) {
            ValueStateDescriptor<Tuple2<Long, Double>> descriptor =
                    new ValueStateDescriptor<>(
                            ...
                            })); // type information; default value is deprecated, needs to check manually
